...
<head>
	...
	<title></title>
	<meta name="description" content="Festacap twibbon generator">
	<meta name="keyword" content="festacap, cilacap, festival, twibbon, generator">
	
</head>
<body style="background: #f9f9f9">
	<nav class="navbar navbar-light bg-white shadow-sm">
		<div class="container">
			<a class="navbar-brand" href="https://festacap.id/">
				<img src="header.png" width="309" height="54">
			...
			<div class="col-lg-6 offset-lg-3 col-md-12 mb-4">
				<div class="card card-body shadow-sm mb-4">
							...
							if ($ukuranfile <= 500000)
							{
								if (in_array($ekstensifile, $jenisfile) && ($ukuranfile <= 500000))
								{
									...
									{       
										...
										echo '<img src="twibb.png" id="img2" width="500px" height="500px" hidden="true" class="img-fluid">';
					...
					<div class="mb-4 font-weight-light">
						<h5 class="font-weight-light">Harmoni Budaya Pesona Wijayakusuma</h5>
						<p>Di dedikasikan untuk seluruh masyarakat Cilacap sebagai upaya untuk melestarikan dan mengembangkan kebudayaan nusantara serta sebagai wujud keadaan kebudayaan yang aktif. Download gambar dan bagikan ke sosial media kamu sebagai bentuk kepedulian terhadap acara ini.</p>
					</div>
	...
	<a href="https://festacap.id" title="contoh twibbon">
		<center>
			<img src="festacap-twibbon.png" alt="Cicacode Logo" class="img-fluid mb-5" width="300">
		</center>
	</a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<i>Upload foto yang ingin kamu jadikan twibbon, pilih file dan klik Buat Twibbon! Download gambar dan bagikan ke sosial media kamu sebagai bentuk kepedulian terhadap acara ini.</i>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		document.getElementById('download').addEventListener('click', function() {
			downloadCanvas(this, 'canvas', 'festacap-twibbon.png');
		}, false);
